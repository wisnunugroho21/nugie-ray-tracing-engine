...
namespace NugieApp {
	...
	IndirectSamplerRenderSystem::~IndirectSamplerRenderSystem() {
	...
	void IndirectSamplerRenderSystem::createPipeline() {
	...
	void IndirectSamplerRenderSystem::render(NugieVulkan::CommandBuffer* commandBuffer, VkDescriptorSet descriptorSets, uint32_t randomSeed) {
