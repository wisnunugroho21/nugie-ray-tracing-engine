...
namespace NugieApp {
	DirectSamplerRenderSystem::DirectSamplerRenderSystem(NugieVulkan::Device* device, NugieVulkan::DescriptorSetLayout* descriptorSetLayout, uint32_t width, uint32_t height, uint32_t nSample) 
	...
	DirectSamplerRenderSystem::~DirectSamplerRenderSystem() {
		vkDestroyPipelineLayout(this->device->getLogicalDevice(), this->pipelineLayout, nullptr);
	}

	void DirectSamplerRenderSystem::createPipelineLayout(NugieVulkan::DescriptorSetLayout* descriptorSetLayout) {
	...
	void DirectSamplerRenderSystem::createPipeline() {
	...
	void DirectSamplerRenderSystem::render(NugieVulkan::CommandBuffer* commandBuffer, VkDescriptorSet descriptorSets, uint32_t randomSeed) {
