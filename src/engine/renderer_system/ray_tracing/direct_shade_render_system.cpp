...
namespace NugieApp {
	DirectShadeRenderSystem::DirectShadeRenderSystem(NugieVulkan::Device* device, NugieVulkan::DescriptorSetLayout descriptorSetLayout, uint32_t width, uint32_t height, uint32_t nSample) 
	...
	DirectShadeRenderSystem::~DirectShadeRenderSystem() {
		vkDestroyPipelineLayout(this->device->getLogicalDevice(), this->pipelineLayout, nullptr);
	}

	void DirectShadeRenderSystem::createPipelineLayout(NugieVulkan::DescriptorSetLayout descriptorSetLayout) {
	...
	void DirectShadeRenderSystem::createPipeline() {
	...
	void DirectShadeRenderSystem::render(NugieVulkan::CommandBuffer* commandBuffer, VkDescriptorSet descriptorSets, uint32_t randomSeed) {
