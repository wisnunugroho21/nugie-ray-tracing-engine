...
namespace NugieApp {
  MissDescSet::MissDescSet(NugieVulkan::Device* device, NugieVulkan::DescriptorPool* descriptorPool,
  ...
  void MissDescSet::createDescriptor(NugieVulkan::Device* device, NugieVulkan::DescriptorPool* descriptorPool, 
		std::vector<VkDescriptorBufferInfo> uniformBufferInfo, std::vector<VkDescriptorBufferInfo> buffersInfo[3]) 
	{
    this->descSetLayout = 
