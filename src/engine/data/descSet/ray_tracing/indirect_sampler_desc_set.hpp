...
namespace NugieApp {
	class IndirectSamplerDescSet {
		public:
			IndirectSamplerDescSet(NugieVulkan::Device* device, NugieVulkan::DescriptorPool* descriptorPool, std::vector<VkDescriptorBufferInfo> uniformBufferInfo, 
