...
namespace NugieApp {
	MissRecordStorageBuffer::MissRecordStorageBuffer(NugieVulkan::Device* device, NugieVulkan::CommandBuffer *commandBuffer, uint32_t dataCount) : device{device} {
		auto datas = std::vector<MissRecord>();
	...
	void MissRecordStorageBuffer::createBuffers(NugieVulkan::CommandBuffer *commandBuffer, std::vector<MissRecord> datas) {
