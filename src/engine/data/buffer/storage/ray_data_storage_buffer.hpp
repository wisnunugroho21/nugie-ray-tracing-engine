...
namespace NugieApp {
	class RayDataStorageBuffer {
		public:
			RayDataStorageBuffer(NugieVulkan::Device* device, NugieVulkan::CommandBuffer *commandBuffer, uint32_t dataCount);
		...
		private:
			...
			void createBuffers(NugieVulkan::CommandBuffer *commandBuffer, std::vector<RayData> datas);
	};
} // namespace NugieApp
