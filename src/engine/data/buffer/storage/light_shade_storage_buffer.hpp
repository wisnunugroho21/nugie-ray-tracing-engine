...
namespace NugieApp {
	class LightShadeStorageBuffer {
		public:
			LightShadeStorageBuffer(NugieVulkan::Device* device, NugieVulkan::CommandBuffer *commandBuffer, uint32_t dataCount);
		...
		private:
			...
			void createBuffers(NugieVulkan::CommandBuffer *commandBuffer, std::vector<LightShadeRecord> datas);
	};
} // namespace NugieApp
